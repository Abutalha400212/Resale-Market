...
const Footer = () => {
    ...
    return (
     ...
     {!loading &&
        <footer className="p-4 bg-gray-700 rounded shadow-xl bordered md:px-6 md:py-8 text-white dark:bg-gray-900 mt-5">
        ...
        <Link to='/' className="flex items-center justify-center text-2xl font-mono text-yellow-400 hover:text-yellow-600"><ShoppingBagIcon className="w-12 h-12 text-yellow-300 "/>Mobile <span className="text-4xl font-semibold">X</span></Link>
            <ul className="md:flex flex-wrap items-center mb-6 text-sm text-white sm:mb-0 dark:text-gray-400">
                <li>
